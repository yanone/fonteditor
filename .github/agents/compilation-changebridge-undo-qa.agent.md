...
- The main agent may not tell you that it added a full JSON transmission, but if you see one in the code, that is a bug that must be fixed before accepting the change. You have to check the actual code for that.
