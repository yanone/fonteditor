...
This project is indexed by GitNexus as **editor** (7736 symbols, 20443 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
