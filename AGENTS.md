...
This project is indexed by GitNexus as **editor** (7807 symbols, 20804 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
