...
This project is indexed by GitNexus as **editor** (18310 symbols, 34891 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
