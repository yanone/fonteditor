...
This project is indexed by GitNexus as **editor** (24044 symbols, 47052 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
