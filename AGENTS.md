...
This project is indexed by GitNexus as **editor** (17198 symbols, 32238 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
