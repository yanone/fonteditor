...
This project is indexed by GitNexus as **editor** (17688 symbols, 33050 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
