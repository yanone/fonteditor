...
This project is indexed by GitNexus as **editor** (24037 symbols, 47049 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
