...
This project is indexed by GitNexus as **editor** (16726 symbols, 31239 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
