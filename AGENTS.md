...
This project is indexed by GitNexus as **editor** (24595 symbols, 47679 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
