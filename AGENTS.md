...
This project is indexed by GitNexus as **editor** (7766 symbols, 20631 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
