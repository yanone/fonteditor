...
This project is indexed by GitNexus as **editor** (24292 symbols, 47437 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
