...
This project is indexed by GitNexus as **editor** (25104 symbols, 49257 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
