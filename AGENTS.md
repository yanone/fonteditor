...
This project is indexed by GitNexus as **editor** (7742 symbols, 20451 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
