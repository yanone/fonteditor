...
This project is indexed by GitNexus as **editor** (21804 symbols, 42025 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
