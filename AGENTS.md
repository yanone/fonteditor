...
This project is indexed by GitNexus as **editor** (25103 symbols, 49270 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
