...
This project is indexed by GitNexus as **editor** (15356 symbols, 28442 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
