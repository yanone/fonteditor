...
In the **Open** dialog choose the **Disk** context, pick your main project folder folder, and allow read and write access. After that, the folder behaves like a normal project tree.
