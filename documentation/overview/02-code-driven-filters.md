...
Built-in filters cover common cases. Custom filters are Python files in `Counterpunch/Filters`. Apply a built-in filter first so you can see the list change, then try a custom script.
